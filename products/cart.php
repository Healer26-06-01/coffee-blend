							...
							<tbody>
								<?php foreach ($allProducts as $product): ?>
									<tr class="text-center">
										...
										<td class="image-prod">
											<div class="img"
												style="background-image:url(<?php echo IMAGEPRODUCTS; ?>/<?php echo $product->image; ?>);">
											</div>
										</td>
				...
				<div class="col col-lg-3 col-md-6 mt-5 cart-wrap ftco-animate">
					<div class="cart-total mb-3">
						...
						<p class="d-flex total-price">
							<span>Total</span>
							<span>$
								<?php echo $allCartTotal->total + 10 - 3; ?>
							</span>
						</p>
					</div>
					<form method="POST" action="cart.php">
						...
						<button name="checkout" type="submit" class="btn btn-primary py-3 px-4">Proceed
							to
							Checkout</button>
