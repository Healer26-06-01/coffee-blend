    ...
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">number of products:
          <?php echo $productsCount->count_products; ?>
        </p>
  ...
  <div class="col-md-3">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">number of orders:
          <?php echo $ordersCount->count_orders ?>
        </p>
  ...
  <div class="col-md-3">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">number of bookings:
          <?php echo $bookingsCount->count_bookings ?>
        </p>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">number of admins:
          <?php echo $adminsCount->count_admins ?>
        </p>
