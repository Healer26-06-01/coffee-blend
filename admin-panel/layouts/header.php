                ...
                <div class="collapse navbar-collapse" id="navbarText">
                    ...
                    <?php if (isset($_SESSION["adminname"])): ?>
                        <ul class="navbar-nav side-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo ADMINURL; ?>/orders-admins/show-orders.php"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo ADMINURL; ?>/bookings-admins/show-bookings.php"
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item"
                                        href="<?php echo ADMINURL; ?>/admins/logout-admins.php">Logout</a>
                            </li>
                        <?php else: ?>
